...
$tempsql="select submit_status from fgusers3 where username='$t'";
$resulttemp=mysql_query($tempsql) or die(mysql_error());
...
print '<center><p>Welcome '.$t.'</p></center>';

$sql2="select id_user from fgusers3 where username='$t'";
 ...
 <input name=T_phone_number type=text id=T_phone_number value="<?php if(isset($T_phone_number)) echo $T_phone_number;?>" onkeypress="return isNumber(event)">        </td>
      ...
      <tr>
        ...
        <td colspan="2">
          ...
          <option <?php if(isset($pstate)&&$pstate=='West Bengal') echo "selected"; ?>>West Bengal</option>          </select>
